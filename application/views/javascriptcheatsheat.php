...
<div class="container">
  <div class="jumbotron mt-2">
    <h1 class="text-center text-danger">javascript cheetSheet</h1>      
...
<!-- Modal to add date-->
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <form  method="POST" action="<?php echo base_url()?>pkdb/insertJAVASCRIPT">
...
<!-- Modal EDIT DATA-->
  <div class="modal fade" id="editData" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <form  method="POST" action="<?php echo base_url()?>pkdb/updateJavascript">
        <div class="form-group">
          ...
          <div class="contentDiv<?php echo $idIs;?>">
            <h4 class="bg-info text-white p-2 mt-1 rounded ButtoncodeShow" id="index<?php echo $idIs;?>">
              ...
              <div class="buttons" style="float: right;margin-bottom: 2px;">
                ...
                <a href='deleteJavascript/<?php echo $idIs;?>' class="justify-content-end text-center btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                </div>
            </h4>
