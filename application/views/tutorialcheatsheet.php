...
<div class="container">
  <div class="jumbotron mt-2">
    <h1 class="text-center text-danger">Tutorials cheetSheet</h1>      
    <p class="text-center text-success">index+preview+code.</p>
    <a href="javascript:void(0)"  class="btn btn-sm btn-danger mb-2" data-toggle="modal" data-target="#myModal">Add Tutorial</a>
  </div>
...
<!-- Modal to add date-->
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <form  method="POST" action="<?php echo base_url()?>pkdb/insertTutorial">
        ...
        <script>
          tinymce.init({
          selector: '#code',  
          plugins: "anchor,lists,image", 
           toolbar: 'bold italic | alignleft aligncenter alignright alignjustify anchor numlist bullist forecolor h1 h3 h5 backcolor fontsizeselect image',   
          });
        </script>
        </div>
        <div class="form-group">
         ...
         <input type="hidden" class="form-control form-control-sm"  name="description" value="empt" placeholder="category">
        </div>
...
<!-- Modal EDIT DATA-->
  <div class="modal fade" id="editData" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <form  method="POST" action="<?php echo base_url()?>pkdb/updateTUT">
        <div class="form-group">
        ...
        ?>
          <div class="contentDiv<?php echo $idIs;?>">
            ...
            <div class="codeSection" style="display:non;">
              <div id="<?php echo $idIs;?>" class='codeIs'><?php echo $data['code']; ?></div>
