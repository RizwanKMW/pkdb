...
<div class="container">
  <div class="jumbotron mt-2">
    <h1 class="text-center text-danger">WORDPRESS cheetSheet</h1>      
    <p class="text-center text-success">index+preview+code.</p>
    <a href="javascript:void(0)"  class="btn btn-sm btn-danger mb-2" data-toggle="modal" data-target="#myModal">Add WORDPRESS Code</a>
  </div>
...
<!-- Modal to add date-->
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <form  method="POST" action="<?php echo base_url()?>pkdb/insertWORDPRESS">
...
<!-- Modal EDIT DATA-->
  <div class="modal fade" id="editData" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <form  method="POST" action="<?php echo base_url()?>pkdb/updateWordpress">
        <div class="form-group">
          ...
          <div class="contentDiv<?php echo $idIs;?>">
            <h4 class="bg-info text-white p-2 mt-1 rounded ButtoncodeShow" id="index<?php echo $idIs;?>">
              ...
              <div class="buttons" style="float: right;margin-bottom: 2px;">
                ...
                <a href='deleteWordpress/<?php echo $idIs;?>' class="justify-content-end text-center btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                </div>
            </h4>
            <div class="codeSection" style="display:non;">
              <pre id="<?php echo $idIs;?>" class='codeIs'><code data-language="php"><?php echo htmlentities( $data['code'] ); ?></code></pre>
  ...
  <script>
    $(document).ready(function(){
      $(".edit").click(function(){ //make ajax call to controller function
            var id=$(this).attr("data-id");
            $.ajax({
            url: 'editWordpress/'+id,
            type: 'POST',
            data: {id: id},
